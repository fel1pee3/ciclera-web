...
export const leadSchema = z.object({
  ...
  technicians: z.enum(['1–4','5–10','11–20','21–30','Mais de 30'], { message: 'Selecione uma opção.' }),
  monthlyOrders: z.enum(['Até 50','51–100','101–300','301–500','Mais de 500'], { message: 'Selecione uma opção.' }),
  currentControl: z.enum(['WhatsApp','Papel','Planilhas','ERP genérico','Software de ordem de serviço','Combinação de ferramentas'], { message: 'Selecione uma opção.' }),
  challenge: z.string().trim().min(10, 'Descreva brevemente a principal dificuldade.').max(1200),
