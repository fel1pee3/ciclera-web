      ...
      <article className="container-page max-w-5xl">
        ...
        <header className="mt-6 overflow-hidden rounded-3xl bg-institutional px-6 py-8 text-primary-foreground sm:px-10 sm:py-12">
          ...
          <p className="mt-5 max-w-3xl text-pretty leading-relaxed text-primary-foreground/75">
            Esta política explica como a Ciclera trata dados pessoais no site e
            na plataforma de gestão de ordens de serviço, em conformidade com a
        ...
        >
          {[
            [
              ShieldCheck,
              'Sem comercialização',
              'A Ciclera não vende dados pessoais.',
            ],
            [
              LockKeyhole,
              'Acesso protegido',
        ...
        <nav
          aria-label="Nesta política"
          className="mt-8 rounded-2xl border border-border bg-card p-5 sm:p-6"
        >
          <p className="font-heading font-semibold">Nesta política</p>
        ...
        <div className="legal-copy">
          <section id="aplicacao" className="scroll-mt-24">
            ...
            <p>
              Para dados necessários ao cadastro, autenticação, cobrança,
              segurança e relacionamento com o assinante, a Ciclera toma as
              decisões essenciais sobre o tratamento e atua como controladora.
            </p>
            <p>
              Para dados de funcionários, clientes, contatos locais e demais
              informações operacionais inseridas por uma organização assinante,
              essa organização normalmente define a finalidade do tratamento e
              atua como controladora. Nesses casos, a Ciclera trata os dados
              para prestar o serviço, na condição de operadora, conforme as
              instruções e configurações da organização.
            </p>
          </section>
          ...
          <section id="dados" className="scroll-mt-24">
            ...
            <ul>
              <li>
                ...
                e-mail, perfil de acesso, situação da conta e aceite dos
                documentos legais.
              </li>
              <li>
                <strong>Autenticação:</strong> hashes de senha e de tokens,
                sessões, datas de acesso e informações necessárias para
                recuperação da conta. Senhas e tokens não são armazenados em
                texto puro.
              </li>
              <li>
                <strong>Clientes e locais:</strong> nome ou razão social,
                documento, e-mail, telefone, endereço, contato local e
                instruções de acesso fornecidas pela organização.
              </li>
              <li>
                <strong>Operação:</strong> equipamentos, ordens de serviço,
                agenda, responsáveis, observações, histórico, materiais,
                serviços, horas e valores relacionados ao atendimento.
              </li>
              <li>
                <strong>Evidências:</strong> fotografias enviadas durante a
                execução. A organização deve evitar incluir pessoas, documentos
                ou dados sensíveis que não sejam necessários ao serviço.
              </li>
              <li>
                <strong>Cobrança:</strong> plano, forma e situação do pagamento,
                vencimentos, referências técnicas e links de cobrança ou
                comprovante disponibilizados pelo Asaas. A Ciclera não recebe
                nem armazena os dados completos do cartão.
              </li>
              <li>
                <strong>Dados técnicos:</strong> endereço IP, origem da
                requisição, navegador, dispositivo, timestamps, request ID,
                registros de segurança, auditoria e diagnóstico de falhas.
              </li>
            </ul>
            <p>
              Os dados são fornecidos pelo próprio titular, pelo proprietário ou
              administrador da organização, pela equipe autorizada, por
              integrações contratadas ou gerados durante o uso da plataforma.
            </p>
          </section>
          ...
          <section id="finalidades" className="scroll-mt-24">
            ...
            <ul>
              ...
              <li>
                executar o contrato, controlar planos, cobranças, limites e
                acesso à operação;
              </li>
              <li>
                registrar ordens, evidências, histórico e auditoria necessários
                à prestação do serviço;
              </li>
              <li>
                prevenir fraude, abuso, acesso indevido e incidentes de
                segurança;
              </li>
              <li>
            ...
            <p>
              Conforme o contexto, utilizamos bases legais como execução de
              contrato e procedimentos preliminares, cumprimento de obrigação
              legal ou regulatória, exercício regular de direitos, legítimo
              interesse com avaliação dos direitos do titular e consentimento
              quando ele for efetivamente necessário.
            </p>
          </section>
          ...
          <section id="compartilhamento" className="scroll-mt-24">
            ...
            <p>
              ...
              proteger direitos ou atender uma solicitação legítima do titular
              ou da organização responsável.
            </p>
            ...
            <ul>
              ...
              <li>
                processamento de cobranças pelo Asaas, sujeito também aos termos
                e políticas do próprio provedor;
              </li>
              <li>
                métricas agregadas de acesso e desempenho por meio da Vercel.
              </li>
            </ul>
            <p>
          ...
          <section id="cookies" className="scroll-mt-24">
            ...
            <p>
              As áreas autenticadas utilizam cookies estritamente necessários
              para manter a sessão e renovar o acesso com segurança. Em
              produção, esses cookies são protegidos por configurações como
              HttpOnly, Secure e SameSite, conforme a topologia dos domínios.
              Bloqueá-los pode impedir o login e o funcionamento da plataforma.
            </p>
            <p>
              A landing page utiliza o Vercel Web Analytics para estatísticas
              agregadas, como páginas acessadas, origem aproximada, país, tipo
              de dispositivo e navegador. Segundo a documentação do serviço,
              essa ferramenta não utiliza cookies para identificar visitantes e
              não permite acompanhá-los entre diferentes dias ou sites.
            </p>
          </section>
          ...
          <section id="retencao" className="scroll-mt-24">
            ...
            <p>
              ...
              ordens, históricos e auditorias já vinculados a ele. Esses
              registros podem ser preservados para manter a integridade da
              operação. O arquivamento de clientes e equipamentos também não
              equivale à eliminação imediata de seus históricos.
            </p>
            <p>
              Solicitações de eliminação serão avaliadas considerando a relação
              entre a Ciclera, a organização controladora e o titular, bem como
              as hipóteses legais de conservação. Cópias residuais podem
              permanecer temporariamente em backups protegidos até sua rotação.
            </p>
          </section>
          ...
          <section id="seguranca" className="scroll-mt-24">
            ...
            <p>
              ...
              serviço, incluindo isolamento entre organizações, controle de
              acesso por perfil, hashes para credenciais, sessões revogáveis,
              evidências privadas, URLs temporárias, auditoria, limitação de
              requisições e registros estruturados sem segredos.
            </p>
            <p>
              Nenhum ambiente é completamente imune a riscos. Em caso de
              incidente relevante, adotaremos medidas de contenção e
              investigação e realizaremos as comunicações exigidas pela LGPD e
          ...
          <section id="direitos" className="scroll-mt-24">
            ...
            <p>
              Nos termos da LGPD e conforme aplicável ao caso concreto, o
            ...
            <ul>
              ...
              <li>
                ...
                essa base, ressalvadas as hipóteses legais de conservação;
              </li>
            ...
            <p>
              ...
              inserido e controlado pela organização assinante, a solicitação
              poderá ser direcionada a ela ou tratada em conjunto.
            </p>
            <a
          ...
          <section id="contato" className="scroll-mt-24">
            ...
            <p>
              A Ciclera é uma plataforma empresarial e não é destinada ao uso
              por crianças ou adolescentes. Contas não devem ser criadas em nome
              de menores de idade.
            </p>
            <p>
              Esta política poderá ser atualizada para refletir mudanças no
              produto, nos fornecedores ou na legislação. Alterações relevantes
              serão comunicadas pelos meios adequados, e a versão vigente ficará
            ...
            <div className="rounded-2xl border border-primary/20 bg-primary/5 p-5">
              ...
              <p>
                ...
                necessários para identificarmos a conta e atendermos a
